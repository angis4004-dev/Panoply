...
export const metadata: Metadata = {
  ...
  description: 'Important risk and informational disclosures about the Aegis platform.',
};
  ...
  return (
    <LegalPageLayout title="Disclaimer" updated="July 2026">
      <section>
        ...
        <p>
          Nothing on Aegis constitutes financial, investment, legal, or tax advice. Signal flow
      ...
      <section>
        ...
        <p>
          ...
          contract risk, including the possibility of bugs or exploits outside Aegis&apos; control.
          Blockchain networks can experience congestion, forks, or other disruptions that affect
      ...
      <section>
        ...
        <p>
          Market data displayed on the platform is sourced from third-party providers. Aegis does
      ...
      <section>
        ...
        <p>
          Use of Aegis does not create a fiduciary, advisory, or brokerage relationship between you
