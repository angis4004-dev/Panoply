        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-8 lg:grid-cols-3">
          ...
          <Reveal delay={200}>
            <div className="h-full rounded-xl border border-ds-border bg-ds-surface-raised/50 p-7">
              ...
              {/* The dashboard names the figure "Modelled P&L"; this is where
                  that name is explained. Kept with the other transparency
                  commitments rather than tucked into a legal page, because a
                  reader who wants to know what a number means looks for it
                  next to the claim that the numbers are open. */}
              <p className="mt-4 border-t border-ds-border pt-4 text-sm text-ds-text-muted leading-relaxed">
                Signal flow performance is generated by Panoply&apos;s performance model, not by
                executed trades. Your wallet balance is separate and is the only figure that
                reflects real funds.
              </p>
            </div>
          </Reveal>
