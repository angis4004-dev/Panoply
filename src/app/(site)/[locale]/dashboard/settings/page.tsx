  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="mx-auto max-w-xl space-y-6">
        ...
        {/* The navbar switcher lives on the marketing pages, which a signed-in
            trader never sees. Without this the dashboard would be the one place
            with no way to change language - and the one place people spend
            their time. */}
        <section className="rounded-xl border border-ds-border bg-ds-surface-raised/50 p-5">
          <h2 className="mb-4 text-sm font-semibold uppercase tracking-wider text-ds-text-muted">
            Language
