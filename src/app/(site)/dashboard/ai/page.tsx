 ...
 *
 * This page used to render a fixed example exchange: a hardcoded "Panoply AI"
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <PageHeader
        ...
        description="Natural-language portfolio analysis, available on the Panoply Vanguard tier."
      />
      ...
      <div className="mx-auto max-w-2xl">
        {loading ? (
          ...
          <div className="rounded-xl border border-ds-border bg-ds-surface-raised/50 p-8">
            ...
            <p className="text-sm leading-relaxed text-ds-text-muted">
              The AI Command Center unlocks at the Panoply Vanguard tier, reached once your lifetime
