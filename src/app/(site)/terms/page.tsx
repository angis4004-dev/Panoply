...
export const metadata: Metadata = {
  title: 'Terms of Service | Panoply',
  description: 'The terms that govern your use of the Panoply platform.',
};
...
export default function TermsPage() {
  return (
    <LegalPageLayout title="Terms of Service" updated="July 2026">
      <p>
        These Terms of Service (&quot;Terms&quot;) govern your access to and use of Panoply. By
      ...
      <section>
        <h2>Eligibility</h2>
        <p>
          You must be able to form a legally binding contract to use Panoply. Access may be
          restricted in certain jurisdictions where use of the platform would be unlawful.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Panoply does not take custody of your assets. You retain control of your own wallet and
          private keys at all times. Panoply provides tooling for research, automation
          configuration, and portfolio analytics only.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Panoply provides signal flows (automated strategy configurations), vault investment
      ...
      <section>
        ...
        <p>
          The Panoply name, branding, and platform software are the property of Panoply and its
      ...
      <section>
        ...
        <p>
          ...
          extent permitted by law, Panoply is not liable for indirect, incidental, or consequential
