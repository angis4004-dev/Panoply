        ...
        <form onSubmit={handleSubmit} className="relative space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="1000"
              className="w-full rounded-lg border border-[#212A35] bg-[#122131] px-3 py-2.5 text-sm text-white placeholder-[#8B95A5] focus:outline-none focus:ring-2 focus:ring-primary/50 focus:shadow-[0_0_16px_-2px_rgba(30,99,255,0.45)] transition duration-fast ease-ds-out"
            />
          </div>
