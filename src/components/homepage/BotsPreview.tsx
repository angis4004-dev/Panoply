    ...
    <section id="bots" className="py-20 border-t border-[#212A35]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          {/* Market chart teaser */}
          <Reveal delay={240}>
            <div className="relative h-full rounded-xl border border-[#212A35] bg-[#122131]/50 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30">
              <SignInBadge />
