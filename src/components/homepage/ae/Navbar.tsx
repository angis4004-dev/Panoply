    ...
    <nav className="bg-background/60 backdrop-blur-sm border-b border-border/5 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="hidden md:flex space-x-8">
          <a href="#features" className="text-[#E7ECF2]/60 hover:text-[#E7ECF2]/80 transition-colors">
            Features
          </a>
          <Link href="/dashboard/ai" className="text-[#E7ECF2]/60 hover:text-[#E7ECF2]/80 transition-colors">
            AI Command Center
          </Link>
          <Link href="/dashboard/bots" className="text-[#E7ECF2]/60 hover:text-[#E7ECF2]/80 transition-colors">
            Trading Bots
          </Link>
          <Link href="/dashboard/vaults" className="text-[#E7ECF2]/60 hover:text-[#E7ECF2]/80 transition-colors">
            Vaults
          </Link>
          <Link href="/dashboard/yield" className="text-[#E7ECF2]/60 hover:text-[#E7ECF2]/80 transition-colors">
            Yield Intelligence
          </Link>
        </div>
