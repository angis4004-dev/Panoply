        ...
        <div className="bg-background/30 border-[#212A35]/20 rounded-xl p-6">
          ...
          <div className="flex items-start space-x-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-foreground/90">
                I found 3 opportunities that may improve your estimated yield while maintaining your current risk profile.
                Would you like me to review the recommendations?
              </p>
          ...
          <div className="mt-6 text-center">
            <Link href="/dashboard/ai" className="inline-flex items-center px-4 py-2 bg-primary text-[#1A1305] font-medium rounded-lg hover:bg-primary/90 transition-colors">
